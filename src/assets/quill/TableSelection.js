// 主体为 ql-better-table 的 table-selection.js

import Quill from 'quill';
import TableCell from '@/assets/quill/format/TableCellFormat';
import { css, getRelativeRect, computeBoundaryFromRects } from '@/assets/quill/utils/table';
